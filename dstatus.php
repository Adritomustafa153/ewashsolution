...
if(isset($_POST['delivery'])){
    ...
    $sql1 = "UPDATE order_data SET o_progress='Delivered',d_status=1 WHERE o_id=$orderid;";
...
$sql = "SELECT c_name,c_contact,d_location,o_id FROM `order_data` WHERE pickman_id = $id AND o_progress='pick';";
...
<body>
  ...
  <div class="container">
    ...
    <form action="dstatus.php" method="post">

<label for=""> Order ID</label>
<input type="text" name="ordid" placeholder="Order ID">
<button type="submit" class="btns" name="delivery">Delivered</button>
        </form>
