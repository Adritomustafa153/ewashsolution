<?php
    ...
    $que = "SELECT name,drywash_price FROM price_list WHERE drywash_price!=0;";
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        <h3 class="text-center">DRY WASH</h3>
        <table class="table">
  ...
  <section class="w3-container w3-center w3-content" style="max-width:600px">
    <h2 class="w3-wide">Ewash-Solution</h2>
